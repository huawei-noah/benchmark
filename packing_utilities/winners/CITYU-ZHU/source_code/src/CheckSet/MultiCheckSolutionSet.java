...
public class MultiCheckSolutionSet {
    ...
    public MultiCheckSolutionSet(String inputDir, String outputDir, String resultFile, String visualizationDir) throws IOException {
    ...
    public MultiCheckSolutionSet(String inputDir, String outputDir, String resultFile) throws IOException {
        this(inputDir, outputDir, resultFile, null);
    }

    public MultiCheckSolutionSet(String inputDir, String outputDir) throws IOException {
    ...
    public void check(String outputMode) throws IOException {
        ...
        for (File order: Objects.requireNonNull(this.orders.listFiles())) {
            ...
            System.out.println("Checking order no.: "+orderNum+" name: " + orderName);
...
//        String outputDir = args[1];
        ...
        String outputDir = ".\\data\\outputs_track22";
        ...
        MultiCheckSolutionSet multiCheck = new MultiCheckSolutionSet(inputDir, outputDir, resultFile, visualizationDir);
